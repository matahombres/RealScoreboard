					...
					if (p.hasMetadata("toggle") == false) {
						...
						for (final String s : Data.getDataList("Config.Disabled-Worlds")) {
							if (p.getLocation().getWorld().getName().equals(s)) {
								...
								org.bukkit.scoreboard.Scoreboard board = Bukkit.getServer().getScoreboardManager()
										.getMainScoreboard();
						...
						org.bukkit.scoreboard.Scoreboard sd = Bukkit.getServer().getScoreboardManager().getMainScoreboard();
